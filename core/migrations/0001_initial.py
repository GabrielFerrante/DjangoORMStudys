    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero', models.CharField(help_text='Máximo 32 caracteres', max_length=32, verbose_name='Chassi')),
            ],
            options={
                'verbose_name': 'Chassi',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('modelo', models.CharField(help_text='Máximo 50 caracteres', max_length=50, verbose_name='Modelo')),
